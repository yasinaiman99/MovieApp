...
// This is a functional component that displays a movie poster
const Movie = (props) => {

    // Get the navigate function from the 'useNavigate' hook in React Router
    const navigate = useNavigate();

    // Handle the click event on the movie poster and navigate to the movie detail page
    const handleClick = () => {
